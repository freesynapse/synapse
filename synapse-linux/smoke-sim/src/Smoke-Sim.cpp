...
void layer::onAttach()
{
	...
	// test fbo setup
	m_surface = Syn::API::newFramebuffer(256, 256, Syn::ColorFormat::RGBA8, true);
	...
	m_finalFramebuffer = Syn::API::newFramebuffer(SCREEN_WIDTH, SCREEN_HEIGHT, Syn::ColorFormat::RGBA16F);
