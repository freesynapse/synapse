...
Smoke::Smoke(uint32_t _screen_width, uint32_t _screen_height)
{
	...
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidAdvect.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidJacobi.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidSubtractGradient.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidComputeDivergence.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidAddDensity.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidBuoyancy.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidObstacles.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidFill.glsl");
	ShaderLibrary::load("/home/iomanip/source/synapse/synapse-linux/smoke-sim/shaders/fluidVisualization.glsl");
...
//-----------------------------------------------------------------------------------
void Smoke::createObstacles(const Ref<FluidFramebuffer>& _frame_buffer)
{
	/* 
	...
	obstacle FluidFramebuffer (m_obstacles).
	*/	
