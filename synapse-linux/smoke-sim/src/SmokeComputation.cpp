...
void Smoke::advect(const Ref<FluidFramebuffer>& _velocity, 
...
//-----------------------------------------------------------------------------------
void Smoke::jacobi(const Ref<FluidFramebuffer>& _pressure, 
...
//-----------------------------------------------------------------------------------
void Smoke::subtractGradient(const Ref<FluidFramebuffer>& _velocity, 
...
//-----------------------------------------------------------------------------------
void Smoke::computeDivergence(const Ref<FluidFramebuffer>& _velocity, 
							  const Ref<FluidFramebuffer>& _obstacles, 
							  const Ref<FluidFramebuffer>& _dest)
{
	SYN_PROFILE_FUNCTION();
...
//-----------------------------------------------------------------------------------
void Smoke::applyImpulse(const Ref<FluidFramebuffer>& _dest, const glm::vec2& _position, float _value)
{
	SYN_PROFILE_FUNCTION();
...
//-----------------------------------------------------------------------------------
void Smoke::applyBuoyancy(const Ref<FluidFramebuffer>& _velocity, 
