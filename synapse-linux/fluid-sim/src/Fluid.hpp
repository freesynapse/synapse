...
namespace Syn {
	...
	public:
		...
		const Ref<FluidFramebuffer> getSrcFBO()	{	return m_front->getFBO(); 		}
		const Ref<FluidFramebuffer> getDstFBO()	{	return m_back->getFBO();  		}
