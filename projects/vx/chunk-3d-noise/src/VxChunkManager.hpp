...
namespace Syn 
{
	...
	public:
		/* Creates a 'block' of chunks, _diameter in x, y and z directions */
		void debugCreateChunks(int _diameter);
		...
		bool renderChunkBoundaries() { return debugChunkBoundariesSet; }
