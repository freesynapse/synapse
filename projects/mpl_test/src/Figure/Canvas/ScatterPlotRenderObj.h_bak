...
namespace Syn
{
    namespace mplc
    {
        class ScatterPlot; // forward decl

        //
        class ScatterPlotRenderObj : public FigureRenderObjBase
        {
        public:
            
            ScatterPlotRenderObj(ScatterPlot* _parent, const glm::vec2& _fig_sz);
            ~ScatterPlotRenderObj() = default;
        ...
        public:
            ScatterPlot* m_parentRawPtr = nullptr;
